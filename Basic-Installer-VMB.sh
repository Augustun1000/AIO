...
sudo pacman -S --noconfirm xorg-server xorg-xinit xorg-xrandr xdg-user-dirs xf86-video-intel vulkan-intel lib32-vulkan-intel vulkan-tools mesa lib32-mesa intel-media-driver libva-utils vdpauinfo clinfo openbox obconf arandr feh thunar thunar-volman gvfs htop neofetch adapta-gtk-theme tint2 networkmanager lm_sensors lxappearance-gtk3 nano geany rofi steam kitty xterm papirus-icon-theme ttf-dejavu ttf-liberation noto-fonts noto-fonts-cjk brightnessctl mtpfs gvfs-mtp gvfs-gphoto2
